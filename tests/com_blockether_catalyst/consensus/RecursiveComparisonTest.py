...
class TestModelDerived:
    ...
    def test_different_model_types_return_false(self) -> None:
        ...
        result = FieldComparator.compare_fields(keyword, acronym, strategy=ComparisonStrategy.DERIVED, threshold=0.8)
        assert result is False
...
class TestEdgeCases:
    ...
    def test_non_model_values_fall_back_to_exact(self) -> None:
        ...
        result = FieldComparator.compare_fields("test", "test", strategy=ComparisonStrategy.DERIVED, threshold=0.8)
        assert result is True
