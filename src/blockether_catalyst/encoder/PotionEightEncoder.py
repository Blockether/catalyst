...
class PotionEightEncoder:
    ...
    def __init__(self):
        ...
        raise RuntimeError(
            "PotionEightEncoder cannot be instantiated. " "Use class methods like PotionEightEncoder.encode() directly."
        )
    ...
    def _initialize(cls) -> None:
        ...
        if not cls._initialized:
            try:
                ...
                local_model_path = module_path / "assets" / "static_models" / "model2vec" / "potion-8M-base"
