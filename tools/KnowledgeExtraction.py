...
class KnowledgeExtraction:
    ...
    def _create_keyword_validation_extractor(self) -> ConsensusKeywordValidationExtractor:
        ...
        domain_expert_config = ConsensusCore.model(
            id="domain-expert",
        ...
        technical_writer_config = ConsensusCore.model(
            id="technical-writer",
        ...
        content_analyst_config = ConsensusCore.model(
            id="content-analyst",
    ...
    def _create_chunk_acronym_discovery_extractor(self) -> ConsensusChunkAcronymDiscoveryExtractor:
        ...
        tech_expert_config = ConsensusCore.model(
        ...
        pattern_specialist_config = ConsensusCore.model(
    ...
    def _create_chunk_keyword_discovery_extractor(self) -> ConsensusChunkKeywordDiscoveryExtractor:
        ...
        info_extraction_config = ConsensusCore.model(
